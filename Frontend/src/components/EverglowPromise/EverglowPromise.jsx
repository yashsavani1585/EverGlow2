    ...
    >
      ...
      >
        ...
        <div className="w-full md:w-1/3 text-center md:text-left relative">
          <h3
            className="text-4xl md:text-5xl font-serif text-yellow-700"
            style={{ fontFamily: "'Garamond', serif" }}
          >
            Everglow
          </h3>
          <h1
            className="text-6xl md:text-7xl font-serif font-bold text-yellow-700 leading-tight"
            style={{ fontFamily: "'Garamond', serif" }}
          >
            Promise
          </h1>
        ...
        {/* Right Grid Box */}
        <div className="w-full md:w-2/3 border-2 border-yellow-700 rounded-md p-10">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10 text-center">
            {promises.map((item, index) => (
              ...
              >
                ...
                <p className="mt-4 text-sm md:text-base font-medium text-yellow-700">
                  {item.text}
                </p>
              </motion.div>
            ))}
