...
//                             </p>
//                             <button className="mt-4 px-6 py-2 bg-[#CEBB98] hover:bg-purple-800 text-white font-medium rounded-lg shadow">
//                                 Explore Offers
//                             </button>
//                         </div>
//                     </div>
...
//                     {/* Place Order Button */}
//                     <button className="w-full bg-purple-800 hover:bg-[#CEBB98] text-white py-3 rounded-md text-lg font-medium mb-6 shadow-md">
//                         place order
//                     </button>
...
//                     Save extra on your next order with exclusive offers
//                   </p>
//                   <button className="mt-4 px-6 py-2 bg-[#CEBB98] hover:bg-[#421543] text-white font-medium rounded-lg shadow">
//                     Explore Offers
//                   </button>
//                 </div>
//               </div>
    ...
    <div className="bg-white min-h-screen py-8 px-4 md:px-10">
      <div className="max-w-7xl mx-auto lg:flex lg:gap-8">
        {products.length === 0 ? (
          ...
          <>
            {/* ---------------- LEFT SECTION ---------------- */}
            <div className="flex-1 space-y-6 max-h-[calc(100vh-4rem)] overflow-y-auto pr-2 scrollbar-hide">
              <h2 className="text-xl font-semibold text-gray-800">
                My Shopping Cart{" "}
                <span className="text-gray-500">({products.length} Items)</span>
              </h2>
